<h2><a href="https://www.geeksforgeeks.org/problems/count-distinct/1">Count Distinct</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a list <strong>arr </strong>that contains integers. You need to count distinct integers in list. </span></p>
